...
static NSString * const GBPerformanceKey = @"GameBoost.PerformanceEnabled";
static NSString * const GBResolutionScaleKey = @"GameBoost.ResolutionScale";
static NSString * const GBSettingsDidChangeNotification = @"GameBoost.SettingsDidChange";
...
static void GBApplyQoSToCurrentRenderThread(void) {
    ...
    if (shouldPromote && !promoted) {
        previousClass = pthread_get_qos_class_np(pthread_self(), &previousRelativePriority);
